...
\label{param:GSIMappingCacheExpiration}
\item[\Macro{GSI\_MAPPING\_CACHE\_EXPIRATION}]
  ...
  The lookup only occurs when the canonical name GSS\_ASSIST\_GRIDMAP is present
  in the HTCondor mapfile.  This defaults to 300 seconds; the special value of
  0 will disable all caching.  The cache uses the DN and VOMS FQAN as a key;
